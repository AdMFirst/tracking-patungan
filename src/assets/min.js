    ...
    components: {
        auth: {
            AuthForm: {
                ...
                signInButton: 'Masuak',
                signUpButton: 'Daftar',
                signUpSuccess: 'Pendaftaran barasil! Cek email Sanak untuak konfirmasi akun.',
                ...
                forgotPassword: 'Lupo kato sandi?',
                enterEmailForPasswordReset: 'Masuakkan alamaik email Sanak untuak ma-reset kato sandi.',
                passwordResetEmailSent: 'Email reset kato sandi alah dikirim. Cek kotak masuak Sanak.',
                passwordResetError: 'Gagal mangirim email reset kato sandi. Cubo baliak.',
            },
        },
        common: {
            BottomNav: {
        ...
        modals: {
            ...
            UpdateEmailModal: {
                title: 'Parbarui Email',
                description: 'Masuakkan alamaik email baru Sanak di bawah.',
                newEmailLabel: 'Email Baru',
                newEmailPlaceholder: 'Masuakkan email baru',
                loading: 'Mambarui...',
                updateButton: 'Parbarui Email',
                successMessage: 'Email konfirmasi alah dikirim. Cek kotak masuak email lamo jo baru Sanak.',
                errorMessage: 'Gagal mambarui email. Cubo baliak.',
            },
            UpdatePasswordModal: {
                title: 'Parbarui Kato Sandi',
                description: 'Masuakkan kato sandi baru Sanak di bawah.',
                newPasswordLabel: 'Kato Sandi Baru',
                newPasswordPlaceholder: 'Masuakkan kato sandi baru',
                confirmPasswordLabel: 'Konfirmasi Kato Sandi',
                confirmPasswordPlaceholder: 'Konfirmasi kato sandi baru',
                passwordsDoNotMatch: 'Kato sandi indak samo',
                loading: 'Mambarui...',
                updateButton: 'Parbarui Kato Sandi',
                successMessage: 'Kato sandi alah diparbarui.',
                errorMessage: 'Gagal mambarui kato sandi. Cubo baliak.',
            },
        },
        UserInfo: {
    ...
    pages: {
        ...
        profile: {
            index: {
                ...
                changePassword: 'Ganti Kato Sandi',
