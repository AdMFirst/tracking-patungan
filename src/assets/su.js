...
const su = {
    components: {
        auth: {
            AuthForm: {
                ...
                signInButton: 'Lebet',
                signUpButton: 'Daptar',
                signUpSuccess: 'Pendaptaran hasil! Mangga parios email anjeun kanggo konfirmasi akun.',
                genericError: 'Aya kasalahan. Cobian deui.',
                discordLoginError: 'Gagal lebet nganggo Discord. Cobian deui.',
                linkedInLoginError:
                    'Gagal lebet nganggo LinkedIn. Cobian deui.',
                forgotPassword: 'Hilap kecap sandi?',
                enterEmailForPasswordReset: 'Lebetkeun alamat email anjeun kanggo ngareset kecap sandi.',
                passwordResetEmailSent: 'Email reset kecap sandi parantos dikirim. Mangga parios koropak anjeun.',
                passwordResetError: 'Gagal ngirim email reset kecap sandi. Cobian deui.',
            },
        },
        common: {
            BottomNav: {
        ...
        room: {
            JoinRoomPrompt: {
                ...
                description:
                    'Kamar ieu aya tapi anjeun teu acan gabung. Bade gabung sareng pesen?',
        ...
        modals: {
            ...
            PaymentModal: {
                ...
                confirmPaymentCheckbox:
                    'Abdi konfirmasi yen abdi parantos mayar',
                cancelButton: 'Batal',
            ...
            UpdateEmailModal: {
                title: 'Nganyarkeun Email',
                description: 'Lebetkeun alamat email anyar anjeun di handap.',
                newEmailLabel: 'Email Anyar',
                newEmailPlaceholder: 'Lebetkeun email anyar',
                loading: 'Nganyarkeun...',
                updateButton: 'Nganyarkeun Email',
                successMessage: 'Email konfirmasi parantos dikirim. Mangga parios koropak email lami sareng anyar anjeun.',
                errorMessage: 'Gagal nganyarkeun email. Cobian deui.',
            },
            UpdatePasswordModal: {
                title: 'Nganyarkeun Kecap Sandi',
                description: 'Lebetkeun kecap sandi anyar anjeun di handap.',
                newPasswordLabel: 'Kecap Sandi Anyar',
                newPasswordPlaceholder: 'Lebetkeun kecap sandi anyar',
                confirmPasswordLabel: 'Konfirmasi Kecap Sandi',
                confirmPasswordPlaceholder: 'Konfirmasi kecap sandi anyar',
                passwordsDoNotMatch: 'Kecap sandi teu sami',
                loading: 'Nganyarkeun...',
                updateButton: 'Nganyarkeun Kecap Sandi',
                successMessage: 'Kecap sandi parantos dianyarkeun.',
                errorMessage: 'Gagal nganyarkeun kecap sandi. Cobian deui.',
            },
        },
        UserInfo: {
    ...
    pages: {
        404: {
            ...
            description:
                'Alamat nu anjeun ketik teu aya. Tong hariwang, hayu wangsul.',
        ...
        myroom: {
            ...
            index: {
                ...
                roomStillOpen:
                    'Kamar masih rame! Hayu lebet sareng tambah pesenan',
        ...
        activeRoom: {
            ...
            errors: {
                ...
                participantRequired:
                    'Anjeun kedah janten peserta kanggo nambah item',
                ...
                deleteOwnItems:
                    'Anjeun mung tiasa ngahapus item anjeun nyalira',
        ...
        profile: {
            index: {
                ...
                changePassword: 'Gantos Kecap Sandi',
            ...
            mypayment: {
                ...
                addPaymentMethodDescription:
                    'Tambah metode pamayaran kanggo nampi artos ti peserta',
