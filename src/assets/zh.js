...
const zh = {
    components: {
        ...
        modals: {
            ...
            UpdateEmailModal: {
                title: '更新电子邮件',
                description: '请在下方输入您的新电子邮件地址。',
                newEmailLabel: '新电子邮件',
                newEmailPlaceholder: '输入新电子邮件',
                loading: '正在更新...',
                updateButton: '更新电子邮件',
                successMessage: '确认邮件已发送。请检查您的旧邮箱和新邮箱。',
                errorMessage: '更新电子邮件失败。请重试。',
            },
            UpdatePasswordModal: {
                title: '更新密码',
