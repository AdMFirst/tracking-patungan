...
const ja = {
    components: {
        auth: {
            AuthForm: {
                ...
                signInButton: 'サインイン',
                signUpButton: 'サインアップ',
                signUpSuccess: '登録が完了しました！メールを確認してアカウントを有効化してください。',
                genericError: 'エラーが発生しました。もう一度お試しください。',
                discordLoginError:
                    'Discordログインの開始に失敗しました。もう一度お試しください。',
                linkedInLoginError:
                    'LinkedInログインの開始に失敗しました。もう一度お試しください。',
                forgotPassword: 'パスワードをお忘れですか？',
                enterEmailForPasswordReset: 'パスワードをリセットするにはメールアドレスを入力してください。',
                passwordResetEmailSent: 'パスワードリセットメールを送信しました。受信トレイを確認してください。',
                passwordResetError: 'パスワードリセットメールの送信に失敗しました。もう一度お試しください。',
            },
        },
        common: {
            BottomNav: {
        ...
        room: {
            JoinRoomPrompt: {
                ...
                description:
                    'このルームは存在しますが、まだ参加していません。参加して注文しますか？',
                noButton: 'いいえ、戻る',
                yesButton: 'はい、参加する',
                joining: '参加中...',
            },
        ...
        modals: {
            ...
            PaymentModal: {
                ...
                confirmPaymentCheckbox:
                    '選択した支払い方法でこの注文の支払いを完了したことを確認します',
                cancelButton: 'キャンセル',
            ...
            UpdateEmailModal: {
                title: 'メールアドレスを更新',
                description: '以下に新しいメールアドレスを入力してください。',
                newEmailLabel: '新しいメールアドレス',
                newEmailPlaceholder: '新しいメールアドレスを入力',
                loading: '更新中...',
                updateButton: 'メールアドレスを更新',
                successMessage: '確認メールを送信しました。新旧両方のメールボックスを確認してください。',
                errorMessage: 'メールアドレスの更新に失敗しました。もう一度お試しください。',
            },
            UpdatePasswordModal: {
                title: 'パスワードを更新',
                ...
                errorMessage: 'パスワードの更新に失敗しました。もう一度お試しください。',
            },
        },
        UserInfo: {
            welcomeBack: 'お帰りなさい！',
    ...
    pages: {
        404: {
            ...
            description:
                '入力したアドレスは存在しないようです。心配しないでください、正しい場所に戻りましょう。',
        ...
        activeRoom: {
            ...
            errors: {
                ...
                joinFailed:
                    'ルームへの参加に失敗しました。もう一度お試しください。',
                participantRequired:
                    'アイテムを追加するには参加者である必要があります',
                addFailed:
                    '注文アイテムの追加に失敗しました。もう一度お試しください。',
                ...
                roomClosed:
                    'このルームは閉鎖されています。アクティブなルームのみアクセス可能です。',
