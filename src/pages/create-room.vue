...
const handleSubmit = async (e) => {
    ...
    const finalDeliveryType = isCustom.value ? customDeliveryType.value : deliveryType.value
...
<template>
    <div class="min-h-screen flex items-start justify-center p-4 sm:items-center">
            ...
            <CardContent>
                <form @submit="handleSubmit" class="grid gap-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select :model-value="deliveryType" @update:model-value="handleDeliveryChange" required>
