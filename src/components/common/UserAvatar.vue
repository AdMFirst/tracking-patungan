...
<template>
    <CardHeader class="flex flex-col items-center text-center pt-8">
        ...
        >
            ...
            <div>
                ...
                <Badge variant="secondary" class="mt-1">{{
                    t('components.common.UserAvatar.connectedViaDiscord')
                }}</Badge>
            </div>
        </div>
        ...
        <!-- LINKEDIN -->
        <div
            v-else-if="props.provider === 'linkedin_oidc'"
            class="flex flex-col items-center space-y-3"
        >
            <Avatar class="w-20 h-20 border-2 border-border">
                <AvatarImage
            ...
            <div>
                ...
                <Badge variant="secondary" class="mt-1">{{
                    t('components.common.UserAvatar.connectedViaLinkedIn')
                }}</Badge>
            </div>
        </div>
        ...
        <div v-else class="flex flex-col items-center space-y-3">
            <Avatar class="w-20 h-20 border-2 border-border">
                <AvatarFallback
                    class="text-xl bg-primary/10 text-primary font-bold"
                >
                    {{ fallbackInitial }}
                </AvatarFallback>
            </Avatar>
            ...
            <div>
                ...
                <Badge variant="secondary" class="mt-1">{{
                    t('components.common.UserAvatar.emailPassword')
                }}</Badge>
            </div>
        </div>
    </CardHeader>
